-- MySQL dump 10.19  Distrib 10.2.43-MariaDB, for debian-linux-gnu (x86_64)
--
...
CREATE TABLE `default_objs` (
  ...
  `attr_defs` longtext COLLATE utf8_bin DEFAULT NULL,
  `attr_values` longtext COLLATE utf8_bin DEFAULT NULL,
...
-- Dump completed on 2022-03-29 13:19:45